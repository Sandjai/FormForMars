...
$("#contactForm").validator().on("submit", function (event) {
  ...
  var request;
    ...
    request.done(function (response, textStatus, jqXHR){
       ...
       $("#resultMsg").html('Заявка получена!<br> Результат <a target="_blank" href="https://docs.google.com/spreadsheets/d/1rR8qkYL57eQC9eQ9dC8pEVfbY11q9DZ04gNt1wzrAss/edit?usp=sharing">здесь</a>');
    });
